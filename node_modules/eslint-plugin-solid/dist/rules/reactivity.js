...
const rule = {
    meta: {
        ...
        messages: {
            ...
            untrackedReactive: "The reactive variable '{{name}}' should be used within JSX, a tracked scope (like createEffect), or inside an event handler function. Details: https://github.com/joshwilsonvu/eslint-plugin-solid/blob/main/docs/reactivity.md.",
            expectedFunctionGotExpression: "The reactive variable '{{name}}' should be wrapped in a function for reactivity. This includes event handler bindings, which are not reactive like other JSX props.",
    ...
    create(context) {
        ...
        const onFunctionEnter = (node) => {
            if ((0, utils_2.isFunctionNode)(node) && scopeStack.syncCallbacks.has(node)) {
                return;
            }
        ...
        const onFunctionExit = (currentScopeNode) => {
            ...
            if ((0, utils_2.isFunctionNode)(currentScopeNode) && currentScopeNode.params.length === 1) {
                ...
                if ((paramsNode === null || paramsNode === void 0 ? void 0 : paramsNode.type) === "Identifier" &&
                    ((currentScope().hasJSX &&
                        ...
                        (0, utils_2.isPropsByName)(paramsNode.name)) &&
                    ((_c = currentScopeNode.parent) === null || _c === void 0 ? void 0 : _c.type) !== "JSXExpressionContainer" &&
                    ((_d = currentScopeNode.parent) === null || _d === void 0 ? void 0 : _d.type) !== "TemplateLiteral") {
            ...
            for (const { reference, declarationScope } of scopeStack.consumeSignalReferencesInScope()) {
                ...
                if (reference.isWrite()) {
                    ...
                    if (((_e = identifier.parent) === null || _e === void 0 ? void 0 : _e.type) === "CallExpression" ||
                        (((_f = identifier.parent) === null || _f === void 0 ? void 0 : _f.type) === "ArrayExpression" &&
                            ((_g = identifier.parent.parent) === null || _g === void 0 ? void 0 : _g.type) === "CallExpression")) {
                        handleTrackedScopes(identifier, declarationScope);
                    }
                    else if (((_h = identifier.parent) === null || _h === void 0 ? void 0 : _h.type) === "TemplateLiteral") {
                        reportBadSignal("template literals");
                    }
                    else if (((_j = identifier.parent) === null || _j === void 0 ? void 0 : _j.type) === "BinaryExpression" &&
                        [
                            "<",
                            "<=",
                            ">",
                    ...
                    else if (((_k = identifier.parent) === null || _k === void 0 ? void 0 : _k.type) === "UnaryExpression" &&
                        ["-", "+", "~"].includes(identifier.parent.operator)) {
                        reportBadSignal("unary expressions");
                    }
                    else if (((_l = identifier.parent) === null || _l === void 0 ? void 0 : _l.type) === "MemberExpression" &&
                        identifier.parent.computed &&
                        identifier.parent.property === identifier) {
                        reportBadSignal("property accesses");
                    }
                    else if (((_m = identifier.parent) === null || _m === void 0 ? void 0 : _m.type) === "JSXExpressionContainer" &&
                        ...
                        if ((elementOrAttribute === null || elementOrAttribute === void 0 ? void 0 : elementOrAttribute.type) === "JSXElement" ||
                            ((elementOrAttribute === null || elementOrAttribute === void 0 ? void 0 : elementOrAttribute.type) === "JSXAttribute" &&
                                ((_o = elementOrAttribute.parent) === null || _o === void 0 ? void 0 : _o.type) === "JSXOpeningElement" &&
            ...
            for (const { reference, declarationScope } of scopeStack.consumePropsReferencesInScope()) {
                ...
                else if (((_p = identifier.parent) === null || _p === void 0 ? void 0 : _p.type) === "MemberExpression" &&
                    identifier.parent.object === identifier) {
                    const { parent } = identifier;
                    if (((_q = parent.parent) === null || _q === void 0 ? void 0 : _q.type) === "AssignmentExpression" && parent.parent.left === parent) {
                        context.report({
                            node: identifier,
                            messageId: "noWrite",
                            data: {
                ...
                else if (((_r = identifier.parent) === null || _r === void 0 ? void 0 : _r.type) === "AssignmentExpression" ||
                    ((_s = identifier.parent) === null || _s === void 0 ? void 0 : _s.type) === "VariableDeclarator") {
                    context.report({
                        node: identifier,
        ...
        return {
            ...
            CallExpression(node) {
                ...
                if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) !== "AssignmentExpression" &&
                    ((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type) !== "VariableDeclarator") {
